---
description: >
  Cheap Claude builder. Implements a feature or fix end-to-end in a fresh
...
family: Claude**. A reviewer from a different family will scrutinise your work,
so leave nothing sloppy.
...
```
BUILDER: build-sonnet (Claude family)
